...
class buy1:
    def __init__(self, root):
        ...
        insertButt = Button(toolbar, text="Buy", font= toolbar_font,bg="#B31312", border=1, relief=tk.RAISED, fg='white', command=self.buy)
        ...
        printButt.pack(side=tk.LEFT, padx=20, pady=2)
        printButt = Button(toolbar, text="Rent", bg="WHITE",font= toolbar_font, border=0, activebackground='#B67352', command=self.rent)
        printButt.pack(side=tk.LEFT, padx=20, pady=2)
        printButt = Button(toolbar, text="Rentup", bg="WHITE",font= toolbar_font, border=0, activebackground='#B67352')
        printButt.pack(side=tk.LEFT, padx=20, pady=2)
        printButt = Button(toolbar, text="Land/Value Graph", bg="WHITE",font= toolbar_font, border=0, activebackground='#B67352')
        printButt.pack(side=tk.LEFT, padx=20, pady=2)
    ...
    def fetch_data(self):
        ...
        try:
            if self.conn.is_connected():
                ...
                cursor.execute("SELECT propertyname, username, price, address, photo1 FROM sell")
